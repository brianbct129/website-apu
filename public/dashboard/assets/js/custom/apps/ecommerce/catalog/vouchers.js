...
var KTAppEcommerceCategories = (function () {
    var t,
        e,
        n = () => {
            t.querySelectorAll('[data-kt-ecommerce-vouchers-filter="delete_row"]').forEach((t) => {
                t.addEventListener("click", function (t) {
                    t.preventDefault();
                    const n = t.target.closest("tr"),
                        o = n.querySelector('[data-kt-ecommerce-vouchers-filter="vouchers_name"]').innerText;
                    Swal.fire({
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_ecommerce_vouchers_table")) &&
                ((e = $(t).DataTable({
                    info: !1,
                    order: [],
                    pageLength: 10,
                ...
                document.querySelector('[data-kt-ecommerce-vouchers-filter="search"]').addEventListener("keyup", function (t) {
