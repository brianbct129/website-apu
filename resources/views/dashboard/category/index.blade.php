            ...
            <tbody class="fw-bold text-gray-600">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <!--begin::Thumbnail-->
                            <a href="/category/edit" class="symbol symbol-50px">
                                <span class="symbol-label" style="background-image:url(assets/media//stock/ecommerce/68.gif);"></span>
                            </a>
                            <!--end::Thumbnail-->
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Computers</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="/category/edit" class="menu-link px-3">Edit</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Watches</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Headphones</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Footwear</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Cameras</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Shirts</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Household</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Toys</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Handbags</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Wines</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="/category/edit" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">Sandals</a>
                                <!--end::Title-->
                                <!--begin::Description-->
...
<script src="{{ asset('dashboard/assets/js/custom/apps/ecommerce/catalog/categories.js') }}"></script>
