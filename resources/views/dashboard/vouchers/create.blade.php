	...
	<div class="card-body pt-0">
		<form id="kt_ecommerce_add_vouchers_form" class="form" data-kt-redirect="/vouchers">
			...
			<div class="mb-10 fv-row">
				...
				<div class="d-flex flex-column text-center mb-5">
					<div class="d-flex align-items-start justify-content-center mb-7">
						<span class="fw-bolder fs-3x" id="kt_ecommerce_add_usage_limit_label">0</span>
			...
			<div class="mb-10 fv-row" id="kt_ecommerce_add_vouchers_discount_fixed">
				<!--begin::Input-->
				<input type="text" name="discounted_price" id="discounted_price" class="form-control mb-2" placeholder="Rp. 0"/>
				<!--end::Input-->
				<!--begin::Description-->
